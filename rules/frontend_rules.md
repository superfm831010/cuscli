...
本文档包含 110 条前端代码检查规则，适用于 Vue/TypeScript 前端开发。
...
**标题**: 依赖安全漏洞扫描
**严重程度**: 高级
**描述**: 定期扫描项目依赖的安全漏洞，禁止使用已知存在高危漏洞的第三方库
...
**标题**: 敏感信息泄漏防护
**严重程度**: 高级
**描述**: 禁止在客户端代码、错误信息、日志中暴露敏感信息（数据库连接、密钥、内部IP等）
...
**标题**: CSP内容安全策略
**严重程度**: 高级
**描述**: 正确配置Content Security Policy，防止XSS攻击
...
**标题**: 图片资源优化
**严重程度**: 中级
**描述**: 图片格式选择规范（PNG用于图标，JPEG用于照片，WebP优先），限制单图大小
...
**标题**: 空状态设计规范
**严重程度**: 低级
**描述**: 列表空状态、数据为空等情况需提供统一的空状态UI和操作引导
